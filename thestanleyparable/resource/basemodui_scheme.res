...
Scheme
{
	...
	BaseSettings
	{
		...
		FooterPanel.TextOffsetY				"0"						[!$GAMECONSOLE && !$POSIX]
		FooterPanel.TextOffsetY				"-1"					[$POSIX]
		...
		NewGameDialog.TextOffsetY			"-1"		[$POSIX]
		SaveLoadGameDialog.TextOffsetY		"-2"	[$GAMECONSOLE]
		SaveLoadGameDialog.TextOffsetY		"-1"		[$POSIX]
	...
	// Custom styles for use with HybridButtons
		...
		HybridButton.TextInsetY						"3"				[!$POSIX]
		HybridButton.TextInsetY						"0"				[$POSIX]
		...
		MainMenuButton.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		MainMenuButton.TextInsetY					"-2"	[$POSIX]
		...
		MainMenuReallySmall.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		MainMenuReallySmall.TextInsetY					"-2"	[$POSIX]
		...
		MainMenuHeader1.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		MainMenuHeader1.TextInsetY					"-2"	[$POSIX]
		...
		MainMenuHeader2.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		MainMenuHeader2.TextInsetY					"-2"	[$POSIX]
		...
		AchievementName.Style						"1"
		AchievementName.TextColor					"255 255 255 255"
		AchievementName.FocusColor					"255 255 255 255"
		AchievementName.CursorColor					"255 255 255 0"
		AchievementName.Font						"AchievementName"
		AchievementName.TextInsetX					"0"
		AchievementName.TextInsetY					"0"
		AchievementName.AllCaps						"0"
		
		AchievementText.Style						"1"
		AchievementText.TextColor					"255 255 255 255"
		AchievementText.FocusColor					"255 255 255 255"
		AchievementText.CursorColor					"255 255 255 0"
		AchievementText.Font						"AchievementDesc"
		AchievementText.TextInsetX					"0"
		AchievementText.TextInsetY					"0"
		AchievementText.AllCaps						"0"

		SaveFile.Style						"1"
		SaveFile.TextColor					"255 255 255 255"
		SaveFile.Font							"SaveFileFont"
		SaveFile.TextInsetX					"10"
		SaveFile.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		SaveFile.TextInsetY					"-2"	[$POSIX]
		...
		GenericConfirmationTitle.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		GenericConfirmationTitle.TextInsetY					"-2"	[$POSIX]
		...
		MainMenuButtonSmall.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		MainMenuButtonSmall.TextInsetY					"-2"	[$POSIX]
		...
		MainMenuButtonSmaller.TextInsetY					"2"		[!$GAMECONSOLE && !$POSIX]
		MainMenuButtonSmaller.TextInsetY					"-2"	[$POSIX]
		...
		BitmapButton.TextInsetY						"0"		[!$POSIX]
		BitmapButton.TextInsetY						"-2"	[$POSIX]
	}
...
//////////////////////// MENU UI /////////////////////////////
		...
		"TSPLoading"
		{
			...
			"1"
			{
				"name"			"League Gothic" [!$POSIX]
				"name"			"LeagueGothic-Regular" [$POSIX]
				"tall"			"40"
				"weight"		"400"
				"antialias"		"1"
			}
		...
		"ControllerLayout"
		{
			...
			"1"
			{
				...
				"name"			"Chonburi-Regular" [$POSIX]
				"tall"		"5"	[$GAMECONSOLE]
				"tall"		"8"	[!$GAMECONSOLE && $WIN32LODEF && !$POSIX]
				"tall"		"5"	[!$GAMECONSOLE && $WIN32HIDEF && !$POSIX]
				"tall"		"8"	[$POSIX]
				"weight"	"400"
				"antialias"	"1"
			}
		...
		"FriendsList"
		{
			...
			"1"
			{
				...
				"name"			"Chonburi-Regular" [$POSIX]
				"tall"		"14" [$GAMECONSOLE]
				"tall"		"10" [!$GAMECONSOLE && !$POSIX]
				"tall"		"14" [!$GAMECONSOLE && $POSIX]
				"weight"	"700"
				"antialias"	"1"
			}
		}	
...
//////////////////////// PUZZLEMAKER /////////////////////////////
    ...
    CustomFontFiles
    {
		...
		"7"		"vgui/fonts/Chonburi-Regular.ttf"
		"8"		"vgui/fonts/pts55f.vfont"
		"9"		"vgui/fonts/pts75f.vfont"
		"10"		"vgui/fonts/osr.vfont"
		"11"		"vgui/fonts/leaguegothic.vfont"
    }
}
